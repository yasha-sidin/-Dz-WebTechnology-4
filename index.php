...
$workExperience = [
  [
    ...
    'dateStart' => 'Feb 2019',
    'dateEnd' => 'Current',
    'discription' => 'I was Web Developer and develop The Facebook site',
  ],
	[
    	'post' => 'BackEnd Developer',
      'dateStart' => 'Jan 2015',
      'dateEnd' => 'Feb 2019',
      'discription' => 'I was Backend Developer and develop backend part of GB.ru',
  ],
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $workExperience[$i]['post']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?php echo $workExperience[$i]['dateStart'] ?>  -  <?php if($workExperience[$i]['dateEnd'] == 'Current') { ?><span
              class="w3-tag w3-teal w3-round">Current</span><?php } else { echo $workExperience[$i]['dateEnd']; } ?></h6>
